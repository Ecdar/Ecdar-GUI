...
public class MutationTestPlanController {
    ...
    public void onTestButtonPressed() {
        ...
        Consumer<List<MutationTestCase>> runTestDriver = (mutationTestCases) -> new TestDriver(mutationTestCases, plan, this::writeProgress, this::writeProgress, sutPathLabel.getText(), 1000, 100).start();
