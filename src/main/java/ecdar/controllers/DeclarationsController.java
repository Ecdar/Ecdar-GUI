...
public class DeclarationsController implements Initializable {
    ...
    private void initializeWidthAndHeight() {
        ...
        root.setMinWidth(MainController.getActiveCanvasPresentation().getController().getWidthProperty().doubleValue());
    ...
    private void updateHeight() {
        final double value = canvasHeight - MainController.getActiveCanvasPresentation().getController().DECLARATION_Y_MARGIN - offSet;
