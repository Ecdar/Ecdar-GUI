            ...
            public void onChanged(final Change<? extends Link> c) {
                links.forEach((link) -> link.setOnMousePressed(event -> {
                    ...
                    if (event.isSecondaryButtonDown() && getComponent().getUnfinishedEdge() == null) {
                        ...
                        DropDownMenu.x = MainController.getActiveCanvasPresentation().mouseTracker.getGridX();
                        DropDownMenu.y = MainController.getActiveCanvasPresentation().mouseTracker.getGridY();
                        ...
                        final double nailX = MainController.getActiveCanvasPresentation().mouseTracker.gridXProperty().subtract(getComponent().getBox().getXProperty()).doubleValue();
                        final double nailY = MainController.getActiveCanvasPresentation().mouseTracker.gridYProperty().subtract(getComponent().getBox().getYProperty()).doubleValue();
